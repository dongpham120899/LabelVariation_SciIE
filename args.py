...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--eval_on', type=str, default="sci",
                            help="Select head to evaluate which sci or sem")
    ...
    arg_parser.add_argument('--alpha', type=float, default=0.5,
                                help="Modify perceptage loss in joint-loss learning")
    arg_parser.add_argument('--use_soft', action='store_true', default=False,
                            help="If true then use soft label")
    arg_parser.add_argument('--inverse_soft_loss', action='store_true', default=False,
                            help="If true then inverse soft loss")
    # Misc
