...
def convert_predictions(batch_entity_clf: torch.tensor, batch_rel_clf: torch.tensor,
                        batch_rels: torch.tensor, batch_entity_sample_masks: torch.tensor, 
                        batch_entity_spans: torch.tensor, rel_filter_threshold: float,
    ...
    batch_entity_types *= batch_entity_sample_masks.long()
